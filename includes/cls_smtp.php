...
class smtp
{
    ...
    function helo()
    {
        if (is_resource($this->connection)
            ...
            $this->errors[] = 'HELO command failed, output: ' . (isset($error) ? trim(substr($error, 3)) : '');
            return false;
        }
    }
    ...
    function ehlo()
    {
        if (is_resource($this->connection)
            ...
            $this->errors[] = 'EHLO command failed, output: ' . (isset($error) ? trim(substr($error, 3)) : '');
    ...
    function auth()
    {
        if (is_resource($this->connection)
            ...
            $this->errors[] = 'AUTH command failed: ' . (isset($error) ? trim(substr($error, 3)) : '');
