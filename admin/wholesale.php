...
class wholesale
{
     ...
     * 批量添加入库
     */
    public function batch_add_insert()
    {
        global $_LANG, $ecs, $db;
        /* 检查权限 */
        admin_priv('whole_sale');
...
switch ($_REQUEST['act']) {
    ...
    case 'batch':
        ...
        break;
    case 'toggle_enabled':
        $wholesale->toggle_enabled();
        break;
    case 'batch_add':
        $wholesale->batch_add();
        break;
    case 'batch_add_insert':
        $wholesale->batch_add_insert();
        break;
    case 'edit':
        $wholesale->edit();
        break;
    case 'update':
        ...
        break;
    case 'search_goods':
        $wholesale->search_goods();
        break;
    case 'get_goods_info':
        $wholesale->get_goods_info();
        break;
    default:
}
...
function wholesale_list()
{
    ...
    if ($result === false) {
        ...
        $sql = "SELECT COUNT(*) FROM " . $GLOBALS['ecs']->table('wholesale') . " WHERE 1 $where";
