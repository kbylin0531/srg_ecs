...
$instance = new AdminLogs();
if(empty($_REQUEST['act']) or 'list' === $_REQUEST['act']){
    $_REQUEST['act']  = 'lists';
}
call_user_func([$instance,$_REQUEST['act']]);