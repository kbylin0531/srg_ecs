...
//-- 编辑调查主题
    /*------------------------------------------------------ */
    public function edit_vote_name()
    {
        global $_LANG, $exc;
        check_authz_json('vote_priv');
...
//-- 编辑调查选项排序值
    /*------------------------------------------------------ */
    public function edit_option_order()
    {
        global $_LANG, $exc_opn;
        check_authz_json('vote_priv');
